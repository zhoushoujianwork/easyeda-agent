...
func AllActions() []ActionSpec {
	return []ActionSpec{
		...
		},
		{
			...
			Inputs:      []string{"allPages optional (WARNING: non-active pages return shallow data — pins/bbox may be empty even when wired; switch to the page via document.switch for accurate data)", "includePins optional (adds pinsAvailable and pinsError on failure)", "includeBBox optional", "includeConnectivitySummary optional (active page only, read-only)"},
